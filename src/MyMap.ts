var config = [
        ...
        {x:0, y:6, walkable:false, image:"noRoad_jpg"},
        ...
        {x:3, y:2, walkable:false, image:"noRoad_jpg"},
        ...
        {x:4, y:6, walkable:false, image:"noRoad_jpg"},
        ...
        {x:5, y:1, walkable:false, image:"noRoad_jpg"},
        {x:5, y:2, walkable:false, image:"noRoad_jpg"},
        {x:5, y:3, walkable:true, image:"road_jpg"},
        {x:5, y:4, walkable:true, image:"road_jpg"},
        {x:5, y:5, walkable:true, image:"road_jpg"},
        {x:5, y:6, walkable:false, image:"noRoad_jpg"},
        ...
        {x:6, y:2, walkable:false, image:"noRoad_jpg"},
        {x:6, y:3, walkable:true, image:"road_jpg"},
        {x:6, y:4, walkable:false, image:"noRoad_jpg"},
        {x:6, y:5, walkable:false, image:"noRoad_jpg"},
        {x:6, y:6, walkable:false, image:"noRoad_jpg"},
        ...
        {x:7, y:2, walkable:false, image:"noRoad_jpg"},
        ...
        {x:8, y:2, walkable:false, image:"noRoad_jpg"},
        ...
        {x:9, y:2, walkable:false, image:"noRoad_jpg"},
        {x:9, y:3, walkable:true, image:"road_jpg"},
        {x:9, y:4, walkable:true, image:"road_jpg"},
        {x:9, y:5, walkable:true, image:"road_jpg"},
        {x:9, y:6, walkable:false, image:"noRoad_jpg"},
        {x:9, y:7, walkable:false, image:"noRoad_jpg"}, 
            ...
            if(aStar.findPath(grid)){
               ...
               if(!move){
                   ...
                   for(var i = 0; i < path.length; i++) {
                       ...
                       playerTween.to({x : path[i].x * MyMap.SIZE, y: path[i].y * MyMap.SIZE}, 300, egret.Ease.sineIn)
                           .call(function(){   
